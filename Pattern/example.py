...
# ## set paths ###
cluster=150
target='test2_'+str(cluster)+'_obama/'
...
corpus_path = '/tmp2/troutman/obama/sentence_wav/'

target_path = '/home/troutman/Documents/proj2/Speech_Summarization/Pattern/Results/' +  target
# init generated by matlab/clusterDetection.m
initial_path = '/home/troutman/Documents/proj2/Speech_Summarization/Pattern/\
zrst/matlab/IDump_timit_dev_'+str(cluster)+'_obama.txt'
config_name = 'test_experiment'

# ## generate pattern ###
# declare object
A = asr.ASR(corpus=corpus_path, target=target_path, dump=initial_path,nState=5)
# initialize
