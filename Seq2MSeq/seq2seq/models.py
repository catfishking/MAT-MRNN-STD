...
from .cells import LSTMDecoderCell, AttentionDecoderCell, MyLSTMDecoderCell
...
def MySeq2Seq(output_dim, output_length, hidden_dim=None, depth=1, broadcast_state=True, inner_broadcast_state=True, teacher_force=False, peek=False, dropout=0., **kwargs):
	'''
